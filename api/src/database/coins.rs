...
impl Database {
    pub(crate) async fn search_coin(&self, query: &str) -> Result<Vec<Coin>, Box<dyn Error>> {
    ...
    pub(crate) async fn get_coin_side(&self, side_id: i64) -> Result<Option<CoinImage>, Box<dyn Error>> {
    ...
    pub(crate) async fn find_coin(&self, id: i64) -> Result<Option<Coin>, Box<dyn Error>> {
